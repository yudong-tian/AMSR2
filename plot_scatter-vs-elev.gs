...
* page, ip 
* -- below 1000 m 
var.1='maskout(snd, 1000-elev);maskout(snd.2, 1000-elev)' 
* -- above 1000 m 
var.2='maskout(snd, elev-1000);maskout(snd.2, elev-1000)' 
...
endwhile
'gxyat -x 3000 -y 4000 scatter-vs-elev-'ip'.png'
'gxyat -x 750 -y 1000 sm-scatter-vs-elev-'ip'.png' 
